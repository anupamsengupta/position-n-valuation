...
class TradeToSettlementIntegrationTest {
    ...
    private static class InMemoryLedgerRepo implements PositionLedgerRepository {
        ...
        @Override public List<PositionLedgerEntry> findAsOf(String t, String tr, Instant b, Instant k) {
            return List.of();
        }
        @Override public List<PositionLedgerEntry> findByDeliveryRange(String t, Instant s, Instant e) {
            return List.of();
        }
